<template>
  ...
  >
    <h2
      ...
      :style="{ paddingBlock: bookings.length ? '2rem' : '0' }"
    >
      Listado de Reservas
    </h2>
    ...
    <div class="overflow-x-auto w-full">
      <section
        class="min-w-max grow-[0.80] flex flex-col items-center justify-start gap-y-4 pt-2.5"
      >
        <div class="flex flex-col gap-y-3">
          <article class="relative flex justify-evenly">
            <article class="flex flex-col gap-y-1">
              <label for="status" class="block text-gray-700 text-sm font-bold">
                Filtrar por Nombre
              </label>
              <input
                v-model="filterName"
                ...
                class="rounded border px-2 py-1 h-9 shadow-sm"
              />
            </article>
            ...
            <article class="flex flex-col gap-y-1">
              ...
              <input
                ...
                class="rounded border px-2 py-1 shadow-sm"
              />
            </article>
            ...
            <article class="flex flex-col gap-y-1">
              ...
              <select
                ...
                class="rounded border px-2 py-1 h-9 bg-white shadow-sm"
              >
            ...
            <button
              ...
              class="font-bold py-2 px-3 rounded bg-gray-500 hover:bg-gray-700 text-white self-end"
            >
              <svg
          ...
          <article class="min-w-max rounded-lg bg-white shadow-md">
            <article
        ...
        <article class="flex justify-between items-center mb-4">
          <NuxtLink
            to="/create-booking"
            class="bg-sky-700 hover:bg-sky-800 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline shadow-md"
